 ...
 */
#if (defined(MBEDTLS_PADLOCK_C) && defined(MBEDTLS_HAVE_X86)) ||        \
    (defined(MBEDTLS_AESNI_C) && defined(MBEDTLS_AESNI_HAVE_CODE) && MBEDTLS_AESNI_HAVE_CODE == 2)
...
#if defined(MBEDTLS_AESNI_C) && defined(MBEDTLS_AESNI_HAVE_CODE) && MBEDTLS_AESNI_HAVE_CODE == 2
